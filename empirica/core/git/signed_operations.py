...
class SignedGitOperations:
    ...
    def commit_signed_state(
        ...
        try:
            ...
            raise git.GitCommandError("git notes add", e.returncode, e.stderr)
    ...
    def get_signed_state_from_commit(self, commit_sha: str) -> Optional[Dict[str, Any]]:
        ...
        except (git.GitCommandError, json.JSONDecodeError, ValueError):
            return None
    ...
    def verify_cascade_chain(
        ...
        Raises:
            git.GitCommandError: If git range is invalid
        """
        results = []
