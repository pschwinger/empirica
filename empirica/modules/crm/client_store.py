...
Uses the main sessions.db database.
"""
...
class ClientStore:
    ...
    Uses the main sessions.db database (clients table).
    """
    ...
    def __init__(self, db_connection=None):
        ...
        Args:
            db_connection: SQLite connection. If None, creates one using path_resolver.
        """
        if db_connection is not None:
            self.conn = db_connection
            self._owns_connection = False
        else:
            # Create connection using standard path resolution
    ...
    def _ensure_schema(self):
        ...
        from empirica.data.schema.crm_schema import SCHEMAS
